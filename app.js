...
var taskInput = document.getElementById("add__new-task");//add task input
var addButton = document.querySelectorAll(".button")[0];//add button
var incompleteTaskHolder = document.querySelector(".incomplete__list");//incompleted list
...
var createNewTaskElement = function(taskString){
    ...
    listItem.classList = "incomplete__list-item list-item";
    label.className = "list-item__label task";
    label.innerText = taskString;

    //Each elements, needs appending
    checkBox.classList = "list-item__status";
